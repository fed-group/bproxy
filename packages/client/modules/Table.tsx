...
// import type { HttpRequestRequest } from '../../../types/web';
// import isElementVisible from '../../modules/isElementVisible';
import { debounce, get } from 'lodash';
import { decodeURL, filterValueIncludes, formatFileSize, showResponseType, formatSeconds } from '../util';
// import { Ctx } from '../ctx';
import './Table.scss';
...
const Table = (props: any) => {
  const { list, addItemIntoList } = useStore(state => state);
            ...
            {list.map((req: any) => {
              ...
              return (
                ...
                >
                  ...
                  {/* path */}
                  <td className="path">
                    <span className="textLimit">{decodeURL(req?.custom?.path)}</span>
                  </td>
                  {/* contentType */}
